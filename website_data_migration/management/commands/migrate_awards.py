...
# and then WebsiteAwardPage instance
...
class Command(BaseCommand):
    """
    Usage:  poetry run python3 manage.py migrate_data
    """

    help = "Import data from XML file"
    ...
    def handle(self, *args, **kwargs):
        ...
        for a in awards:
            ...
            awards_index_page = WebsiteAwardsIndexPage.objects.all().first()
